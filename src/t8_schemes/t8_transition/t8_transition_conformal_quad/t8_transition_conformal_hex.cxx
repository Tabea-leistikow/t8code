...
t8_scheme_new_transition_cxx (void)
{
  ...
  s->eclass_schemes[T8_ECLASS_TRIANGLE] = NULL;       /* can be used for hybrid meshes - not conformal as long as no conformal transition tri class exists */
...
t8_eclass_scheme_is_transition (t8_eclass_scheme_c *ts)
{
  ...
  case T8_ECLASS_LINE:
    return 0;
  case T8_ECLASS_HEX:
    return T8_COMMON_IS_TYPE (ts, t8_subelement_scheme_hex_c *);
